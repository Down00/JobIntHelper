...
export default function Index() {
    ...
    if (quizFinished) {
        return <ResultScreen result={result} onRetry={startQuiz} />; // Show result screen if quiz is finished
    }
            ...
            {!quizStarted && (
                <View style={styles.instructionContainer}>
                    ...
                    <Text style={styles.instructionText}>
                        This quiz is designed to assess your skills across various tech roles, including Software Development, Web Development, Data Science, and more. Answer each question to the best of your ability, and at the end, you'll discover the tech career path that suits you best!
                    </Text>
                ...
                <View style={styles.quizContainer}>
                    ...
                    {quizQuestions[currentQuestion].options.map((option, index) => (
                        <TouchableOpacity
                            ...
                            style={[
                                styles.optionButton,
                                selectedAnswer === option && option !== correctAnswer ? styles.incorrectOption : null,
