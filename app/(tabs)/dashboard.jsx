...
export default function Dashboard() {
  ...
  return (
    <View style={{ flexGrow: 1 }}>
      ...
      <Text style={styles.userSubHeaderText2}>Let's not wait anymore, Let's do this</Text>
              ...
              <View style={{ marginLeft: 10 }}>
                {item === ResumeGenerator[0] ? (
                  ...
                  <TouchableOpacity onPress={navigateToGeneralQuiz}>
                    <Text style={styles.featureText}>Unlock your tech Path</Text>
      ...
      <View style={styles.learningResources}>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/lAFbKzO-fss?si=l0Dwr5baP3DeAOkL' }}
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/8jH07r6135o?si=eWjUZSgBxKdTCqv5' }}
            style={styles.videoPlayer}
          />
        </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/ZcZu1NYx-WE?si=lRQDswdYiLuzkYe4' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/_uQrJ0TkZlc?si=mwIM3kry67soC4T_' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/nu_pCVPKzTk?si=4PFxj2HWabMhY-VE' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/wxznTygnRfQ?si=MgR0t3AuI3oNwgjH' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/-TkoO8Z07hI?si=AhWu7aEmDvcnITR2' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/AmGSEH7QcDg?si=wjnvAx5n2D9X66We' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/6UlU_FsicK8?si=34CT5QbjS01vfOhB' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
        ...
        <View style={styles.videoContainer}>
          <WebView
            source={{ uri: 'https://www.youtube.com/embed/xk4_1vDrzzo?si=EMfc4w5OQ2HNNT6r' }}
            style={styles.videoPlayer}
          />
          </View>
        </View>
