      ...
      <View style={{flex: 1, backgroundColor: '#292929'}}>
        <View style={styles.profileWrapper}>
          <View style={[styles.profileSection, styles.profileSectionLeft]}>
            <View style={styles.imageWrapper}>
                {profilePicture ? (
                  <Image source={{ uri: profilePicture || 'default-placeholder-image-url' }} style={styles.profilePic} />
                ) : (
            ...
            <Text style={[styles.fullName, { color: '#c1c1c1' }]}>{fullName}</Text>
          </View>
    
          <View style={[styles.editProfileButtonWrapper, {backgroundColor: '#2E7C81', borderRadius: 13}]}>
            <TouchableOpacity onPress={() => router.push('./../screens/edit-profile')} style={styles.editButton}>
              <Text style={[styles.editButtonText, {color: '#e5e5e5'}]}>Edit Profile</Text>
            </TouchableOpacity>
          </View>
        </View>
        ...
        {/* Act-History */}
          <TouchableOpacity onPress={() => router.push('./../screens/about-app')}style={styles.optionabout}>
            ...
            {/* Rate our App */}
            <TouchableOpacity onPress={() => router.push('./../screens/rate-our-app')} style={styles.optionabout}>
              <Feather name="star" size={27} color={ "#1C2A38" } />
              <Text style={[styles.optionText, { color: "#1C2A38" , fontFamily: 'outfit' }]}>Rate our app</Text>
              <Ionicons
                name="chevron-forward"
                size={18}
                color={ "#1C2A38" }
            ...
            {/* About This App */}
              ...
              <Text style={[styles.optionText, { color: "#1C2A38" , fontFamily: 'outfit' }]}>About</Text>
              <Ionicons
                name="chevron-forward"
                size={18}
                color={ "#1C2A38" }
            ...
            <TouchableOpacity style={styles.optionlogout} onPress={handleLogout}>
              ...
              <Text style={[styles.optionText, { color:"#1C2A38" , fontFamily: 'outfit' }]}>Logout</Text>
              <Ionicons
                name="chevron-forward"
                size={18}
                color={"#1C2A38"}
